...
4. Dans **Vercel → Settings → Environment Variables**, ajoutez `DATABASE_URL` pour Production, Preview et Development. Ne placez jamais cette valeur dans le code, GitHub ou le navigateur.
